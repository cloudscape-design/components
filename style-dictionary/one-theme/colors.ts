...
const tokens: StyleDictionary.ColorsDictionary = {
  ...
  // ── Normal button ─────────────────────────────────────────────────────────
  colorBorderButtonNormalDefault: { light: '{colorNeutral600}', dark: '{colorNeutral600}' },
  colorBorderButtonNormalHover: { light: '{colorNeutral700}', dark: '{colorNeutral500}' },
  colorBorderButtonNormalActive: { light: '{colorNeutral300}', dark: '{colorNeutral500}' },
  colorBorderButtonNormalDisabled: { light: '{colorNeutral300}', dark: '{colorNeutral700}' },
  colorBackgroundButtonNormalDefault: { light: '{colorNeutral250}', dark: '{colorNeutral950}' },
  colorBackgroundButtonNormalHover: { light: '{colorNeutral100}', dark: '{colorNeutral850}' },
  colorBackgroundButtonNormalActive: { light: '{colorNeutral150}', dark: '{colorNeutral950}' },
  colorBackgroundButtonNormalDisabled: { light: '{colorNeutral100}', dark: '{colorNeutral900}' },
  ...
  // ── Tertiary button ─────────────────────────────────────────────────────────
  colorBackgroundButtonLinkDefault: { light: '{colorNeutral100}', dark: 'transparent' },
  colorBackgroundButtonLinkHover: { light: '{colorNeutral100}', dark: '{colorNeutral800}' },
  colorBackgroundButtonLinkActive: { light: '{colorNeutral150}', dark: '{colorNeutral850}' },
  colorBackgroundButtonLinkDisabled: { light: '{colorNeutral100}', dark: 'transparent' },
  colorTextButtonLinkDefault: { light: '{colorNeutral800}', dark: '{colorNeutral350}' },
  colorTextButtonLinkHover: { light: '{colorNeutral800}', dark: '{colorNeutral250}' },
  colorTextButtonLinkActive: { light: '{colorNeutral800}', dark: '{colorNeutral300}' },
  colorTextButtonLinkDisabled: { light: '{colorNeutral600}', dark: '{colorNeutral650}' },

  // ── Primary button ────────────────────────────────────────────────────────
  colorBackgroundButtonPrimaryDefault: { light: '{colorNeutral900}', dark: '{colorNeutral300}' },
  colorBackgroundButtonPrimaryHover: { light: '{colorNeutral800}', dark: '{colorNeutral200}' },
  colorBackgroundButtonPrimaryActive: { light: '{colorNeutral900}', dark: '{colorNeutral300}' },
  colorBackgroundButtonPrimaryDisabled: { light: '{colorNeutral100}', dark: '{colorNeutral700}' },
  colorTextButtonPrimaryDefault: { light: '{colorNeutral200}', dark: '{colorNeutral950}' },
  colorTextButtonPrimaryHover: { light: '{colorNeutral100}', dark: '{colorNeutral950}' },
  colorTextButtonPrimaryActive: { light: '{colorNeutral100}', dark: '{colorNeutral950}' },
  colorTextButtonPrimaryDisabled: { light: '{colorNeutral400}', dark: '{colorNeutral950}' },
