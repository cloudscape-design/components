...
const tokens: StyleDictionary.ColorsDictionary = {
  ...
  colorBackgroundButtonPrimaryActive: { light: '#5c7fff', dark: '#5c7fff' },
  colorBackgroundButtonPrimaryDefault: { light: '#5c7fff', dark: '#5c7fff' },
  colorBackgroundButtonPrimaryDisabled: { light: '{colorNeutral250}', dark: '{colorNeutral750}' },
  colorBackgroundButtonPrimaryHover: { light: '#7598ff', dark: '#7598ff' },
