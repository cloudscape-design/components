...
// Override the primary color scale (VR uses blue; one-theme uses indigo).
// These go through addTokens so they win over the reference tokens generated by buildVisualRefresh.
const primaryOverrides: StyleDictionary.ExpandedColorScopeDictionary = expandColorDictionary({
  colorPrimary50: brand.colorIndigo50,
  colorPrimary100: brand.colorIndigo100,
  colorPrimary200: brand.colorIndigo200,
  colorPrimary300: brand.colorIndigo300,
  colorPrimary400: brand.colorIndigo400,
  colorPrimary500: brand.colorIndigo500,
  colorPrimary600: brand.colorIndigo600,
  colorPrimary700: brand.colorIndigo700,
  colorPrimary800: brand.colorIndigo800,
  colorPrimary900: brand.colorIndigo900,
  colorPrimary1000: brand.colorIndigo1000,
});
