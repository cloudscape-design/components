...
const tokens: StyleDictionary.ColorsDictionary = {
  ...
  colorBackgroundDrawerBackdrop: '{colorBackgroundBackdrop}',
  colorBackgroundLayoutMobilePanel: '{colorNeutral950}',
  colorBackgroundLayoutPanel: '{colorBackgroundContainerContent}',
  ...
  colorBackgroundLayoutToolbar: '{colorBackgroundLayoutPanelContent}',
  ...
  colorBackgroundModalOverlay: '{colorBackgroundBackdrop}',
  ...
  colorBackgroundFlashbarSuccess: '{colorBackgroundNotificationGreen}',
  colorBackgroundFlashbarError: '{colorBackgroundNotificationRed}',
  colorBackgroundFlashbarInfo: '{colorBackgroundNotificationBlue}',
  colorBackgroundFlashbarWarning: '{colorBackgroundNotificationYellow}',
  ...
  colorBackgroundSliderRangeDefault: '{colorBackgroundSliderHandleDefault}',
  colorBackgroundSliderRangeActive: '{colorBackgroundSliderHandleActive}',
  ...
  colorBackgroundSliderHandleErrorDefault: '{colorTextStatusError}',
  colorBackgroundSliderHandleErrorActive: '{colorTextStatusError}',
  colorBackgroundSliderHandleWarningDefault: '{colorTextStatusWarning}',
  colorBackgroundSliderHandleWarningActive: '{colorTextStatusWarning}',
  colorBackgroundSliderRangeErrorDefault: '{colorTextStatusError}',
  colorBackgroundSliderRangeErrorActive: '{colorTextStatusError}',
  colorBackgroundSliderRangeWarningDefault: '{colorTextStatusWarning}',
  ...
  colorBorderButtonLinkDisabled: '{colorBackgroundButtonLinkDisabled}',
  ...
  colorBorderButtonPrimaryActive: '{colorBackgroundButtonPrimaryActive}',
  colorBorderButtonPrimaryDefault: '{colorBackgroundButtonPrimaryDefault}',
  colorBorderButtonPrimaryDisabled: '{colorBackgroundButtonPrimaryDisabled}',
  colorBorderButtonPrimaryHover: '{colorBackgroundButtonPrimaryHover}',
  ...
  colorTextSideNavigationItemActiveCollapsed: '{colorTextInverted}',
  ...
  colorTextButtonLinkActive: '{colorTextButtonNormalActive}',
  colorTextButtonLinkDefault: '{colorTextButtonNormalDefault}',
  colorTextButtonLinkDisabled: '{colorTextInteractiveDisabled}',
  colorTextButtonLinkHover: '{colorTextButtonNormalHover}',
  ...
  colorBackgroundBadgeRed: '{colorBackgroundNotificationRed}',
  colorBackgroundBadgeYellow: '{colorBackgroundNotificationYellow}',
  colorBackgroundBadgeGrey: '{colorBackgroundNotificationGrey}',
  ...
  // ── Visual accent ───────────────────────────────────
  colorBackgroundAccentRed: { light: '{colorError50}', dark: 'rgba(153, 0, 0, 0.4)' },
  colorBackgroundAccentYellow: { light: '{colorWarning50}', dark: 'rgba(158, 105, 0, 0.4)' },
  colorBackgroundAccentIndigo: { light: '{colorInfo50}', dark: 'rgba(0, 59, 143, 0.4)' },
  colorBackgroundAccentGreen: { light: '{colorSuccess50}', dark: 'rgba(0, 92, 38, 0.4)' },
  colorBackgroundAccentOrange: { light: '{colorOrange50}', dark: 'rgba(138, 32, 0, 0.4)' },
  colorBackgroundAccentPurple: { light: '{colorPurple50}', dark: 'rgba(89, 0, 178, 0.4)' },
  colorBackgroundAccentMint: { light: '{colorMint50}', dark: 'rgba(0, 82, 55, 0.4)' },
  colorBackgroundAccentLime: { light: '{colorLime50}', dark: 'rgba(0, 87, 0, 0.4)' },
  colorBackgroundAccentGrey: { light: '{colorNeutral150}', dark: '{colorNeutral750}' },
  colorBackgroundAccentTeal: { light: '{colorTeal50}', dark: 'rgba(0, 82, 76, 0.4)' },
  colorBackgroundAccentCyan: { light: '{colorCyan50}', dark: 'rgba(0, 71, 97, 0.4)' },
  colorBackgroundAccentBlue: { light: '{colorInfo50}', dark: 'rgba(0, 59, 143, 0.4)' },
  colorBackgroundAccentViolet: { light: '{colorViolet50}', dark: 'rgba(66, 0, 219, 0.4)' },
  colorBackgroundAccentFuchsia: { light: '{colorFuchsia50}', dark: 'rgba(120, 0, 138, 0.4)' },
  colorBackgroundAccentMagenta: { light: '{colorMagenta50}', dark: 'rgba(143, 0, 114, 0.4)' },
  colorBackgroundAccentPink: { light: '{colorPink50}', dark: 'rgba(143, 0, 71, 0.4)' },
  colorBackgroundAccentRose: { light: '{colorRose50}', dark: 'rgba(148, 0, 37, 0.4)' },
  colorBackgroundAccentAmber: { light: '{colorAmber50}', dark: 'rgba(122, 43, 0, 0.4)' },
  ...
  colorTextAccentIndigo: { light: '{colorInfo600}', dark: '{colorInfo300}' },
  colorTextAccentGreen: { light: '{colorSuccess600}', dark: '{colorSuccess400}' },
  colorTextAccentOrange: { light: '{colorOrange700}', dark: '{colorOrange400}' },
  colorTextAccentPurple: { light: '{colorPurple700}', dark: '{colorPurple400}' },
  colorTextAccentMint: { light: '{colorMint700}', dark: '{colorMint400}' },
  colorTextAccentLime: { light: '{colorLime700}', dark: '{colorLime400}' },
  colorTextAccentGrey: { light: '{colorNeutral800}', dark: '{colorNeutral200}' },
  colorTextAccentTeal: { light: '{colorTeal700}', dark: '{colorTeal400}' },
  colorTextAccentCyan: { light: '{colorCyan700}', dark: '{colorCyan400}' },
  colorTextAccentBlue: { light: '{colorInfo700}', dark: '{colorInfo400}' },
  colorTextAccentViolet: { light: '{colorViolet700}', dark: '{colorViolet400}' },
  colorTextAccentFuchsia: { light: '{colorFuchsia700}', dark: '{colorFuchsia400}' },
  colorTextAccentMagenta: { light: '{colorMagenta700}', dark: '{colorMagenta400}' },
  colorTextAccentPink: { light: '{colorPink700}', dark: '{colorPink400}' },
  colorTextAccentRose: { light: '{colorRose700}', dark: '{colorRose400}' },
  colorTextAccentAmber: { light: '{colorAmber700}', dark: '{colorAmber400}' },
};
