...
const tokens: StyleDictionary.ColorsDictionary = {
  ...
  colorBackgroundChatBubbleSent: 'transparent',
  colorBackgroundChatBubbleReceived: { light: '{colorGrey150}', dark: '{colorGrey850}' },
  colorTextChatBubbleSent: '{colorTextBodyDefault}',
  colorTextChatBubbleReceived: '{colorTextBodyDefault}',
