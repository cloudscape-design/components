...
const tokens: StyleDictionary.ColorsDictionary = {
  ...
  colorBackgroundCardEmbedded: '{colorBackgroundCard}',
  ...
  colorBackgroundDrawerBackdrop: '{colorGreyOpaque70}',
  ...
  colorBorderCardEmbedded: '{colorBorderCard}',
  colorBorderCardHighlighted: '{colorBorderItemSelected}',
  colorBorderContainer: '{colorBorderDividerDefault}',
  ...
  colorBackgroundActionCardDefault: '{colorBackgroundButtonNormalDefault}',
  colorBackgroundActionCardHover: '{colorBackgroundButtonNormalHover}',
  colorBackgroundActionCardActive: '{colorBackgroundButtonNormalActive}',
  colorBorderActionCardDefault: '{colorBorderButtonNormalDefault}',
  colorBorderActionCardHover: '{colorBorderButtonNormalHover}',
  colorBorderActionCardActive: '{colorBorderButtonNormalActive}',
  colorBorderActionCardDisabled: '{colorBorderButtonNormalDisabled}',
  colorBackgroundActionCardDisabled: '{colorBackgroundButtonNormalDisabled}',
  colorTextActionCardDisabled: '{colorTextButtonNormalDisabled}',
  colorIconActionCardDefault: '{colorTextButtonNormalDefault}',
  colorIconActionCardHover: '{colorTextButtonNormalHover}',
  colorIconActionCardActive: '{colorTextButtonNormalActive}',
  colorIconActionCardDisabled: '{colorTextInteractiveDisabled}',
};
