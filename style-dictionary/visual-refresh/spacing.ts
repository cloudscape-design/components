...
const tokens: StyleDictionary.SpacingDictionary = {
  ...
  spaceDialogHorizontal: '{spaceCardHorizontalEmbedded}',
  spaceDialogVertical: '{spaceCardVerticalEmbedded}',
  spaceDialogActionBlock: '{spaceScaledXxs}',
  spaceDialogActionInline: '{spaceXxs}',
  spaceDialogHeaderGap: '{spaceXs}',
  spaceDialogSectionGap: '{spaceXxs}',
  ...
  spaceFlashbarVertical: '{spaceScaledXs}',
  ...
  spaceSideNavigationItemDefaultGap: '{spaceNone}',
  spaceSideNavigationItemIconGap: '{spaceXxs}',
