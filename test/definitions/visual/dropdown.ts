...
const suite: TestSuite = {
  ...
  tests: [
    ...
    ...[false, true].map<TestSuite>(expandToViewport => ({
      description: `expandToViewport=${expandToViewport}`,
      tests: [
        {
          description: 'positions select inside modal',
        ...
        {
          description: 'positions select inside popover',
          path: 'dropdown/expandable',
          screenshotType: 'viewport',
          queryParams: { componentType: 'Select', expandToViewport: `${expandToViewport}` },
          setup: async ({ page }) => {
        ...
        {
          description: 'select has bottom borders when opened upwards',
          path: 'dropdown/expandable',
          screenshotType: 'viewport',
          queryParams: { componentType: 'Select', expandToViewport: `${expandToViewport}` },
          setup: async ({ page }) => {
