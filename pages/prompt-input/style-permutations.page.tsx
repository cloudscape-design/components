...
const style1: PromptInputProps.Style = {
  root: {
    ...
    borderRadius: '8px',
    backgroundColor: {
      default: 'light-dark(#f0f9ff, #0c2a3a)',
      hover: 'light-dark(#e0f2fe, #0d3040)',
      focus: 'light-dark(#e0f2fe, #0d3040)',
      disabled: 'light-dark(#f0f9ff, #0c2a3a)',
      readonly: 'light-dark(#f0f9ff, #0c2a3a)',
    },
    boxShadow: {
    ...
    color: {
      default: 'light-dark(#0c4a6e, #7dd3fc)',
      hover: 'light-dark(#0c4a6e, #7dd3fc)',
      focus: 'light-dark(#0c4a6e, #7dd3fc)',
      disabled: '#7dd3fc',
...
const style2: PromptInputProps.Style = {
  root: {
    ...
    borderRadius: '10px',
    backgroundColor: {
      default: 'light-dark(#faf5ff, #2d1b4e)',
      hover: 'light-dark(#f5f3ff, #341f5c)',
      focus: 'light-dark(#f5f3ff, #341f5c)',
      disabled: 'light-dark(#faf5ff, #2d1b4e)',
      readonly: 'light-dark(#faf5ff, #2d1b4e)',
    },
    boxShadow: {
      default: '0 1px 2px rgba(0, 0, 0, 0.05)',
    ...
    color: {
      default: 'light-dark(#581c87, #c4b5fd)',
      hover: 'light-dark(#581c87, #c4b5fd)',
      focus: 'light-dark(#3b0764, #c4b5fd)',
      disabled: '#a78bfa',
      readonly: 'light-dark(#6b21a8, #c4b5fd)',
    },
    fontSize: '14px',
    fontWeight: '400',
    paddingBlock: '4px',
