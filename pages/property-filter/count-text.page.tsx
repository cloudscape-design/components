...
import { PropertyFilterProps, SpaceBetween } from '../../lib/components-themeable/internal/template';
  ...
  return (
    <I18nProvider messages={[messages]} locale="en">
      ...
      <SpaceBetween size="l">
        ...
        <Button onClick={() => propertyFilterRef.current?.renderCountTextAriaLive()}>Announce count text</Button>
      </SpaceBetween>
    </I18nProvider>
  );
}
