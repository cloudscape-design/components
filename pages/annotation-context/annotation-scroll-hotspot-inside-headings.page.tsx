      ...
      <ScreenshotArea>
        ...
        >
          <div className={styles.parent}>
            <span />
            <h1>
              Heading 1<Hotspot data-testid="hotspot-1" hotspotId={tutorial.tasks[0].steps[0].hotspotId}></Hotspot>
            </h1>
            <h2>
              Heading 2 <Hotspot data-testid="hotspot-2" hotspotId={tutorial.tasks[0].steps[2].hotspotId} />
            </h2>
          </div>
