...
const displayFormatOptions: SelectProps.Option[] = [...inputFormatOptions, { value: 'long-localized' }];
      ...
      <SpaceBetween direction="vertical" size="m">
        ...
        <SpaceBetween size="m">
          ...
          <SpaceBetween direction="horizontal" size="s">
            ...
            <div style={{ minWidth: 200 }}>
              <Select
                inlineLabelText="Display format"
                options={displayFormatOptions}
                selectedOption={displayFormatOptions.find(o => o.value === urlParams.format) ?? null}
                onChange={({ detail }) =>
        ...
        <DateInput
          ...
          placeholder={getPlaceholder({
            ...
            inputFormat: urlParams.inputFormat ?? 'slashed',
          })}
          value={value}
