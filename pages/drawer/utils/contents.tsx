...
export const longHeader = <p>Lorem nesciunt praesentium voluptatem, molestias aliquid animi aspernatur!</p>;

export const shortHeader = <p>Lorem nesciunt!</p>;

export const longFooter = <p>Lorem nesciunt praesentium voluptatem, molestias aliquid animi aspernatur!</p>;

export const shortFooter = <p>Lorem nesciuntnatur!</p>;
