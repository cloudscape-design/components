...
const permutations = createPermutations<AlertProps>([
  {
    ...
    action: [
      null,
      <Button>Action longer button</Button>,
      // e.g. https://code.amazon.com/packages/S3ConsoleV3UI/blobs/5677e266b3e091e89eeee5b8f7a30a6e5c925d82/--/src/s3/components/bucket-replication/edit/destination-section/async-validations/destination-object-lock-alert.tsx#L112
