...
const items: ButtonGroupProps.Item[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        text: 'Dislike',
        feedbackPopover: <StatusIndicator type="error">Disliked</StatusIndicator>,
      },
    ],
  },
  {
    ...
    iconName: 'copy',
    text: 'Copy',
    feedbackPopover: <StatusIndicator type="success">Copied</StatusIndicator>,
  },
  {
    type: 'group',
    text: 'Actions',
