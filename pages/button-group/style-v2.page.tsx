...
export default function ButtonGroupStyleV2Page() {
  ...
  return (
    ...
    >
      <ButtonGroup className={styles['button-group-minimal']} variant="icon" items={items} onItemClick={handleClick} />
      <ButtonGroup className={styles['button-group-card']} variant="icon" items={items} onItemClick={handleClick} />
    </SimplePage>
  );
}
