...
const blueSquareStyle: ToggleButtonProps['style'] = {
  root: {
    background: {
      default: '#2563eb',
      hover: '#1d4ed8',
...
const purpleRoundedStyle: ToggleButtonProps['style'] = {
  root: {
    background: {
      default: '#7c3aed',
      hover: '#6d28d9',
...
const blueIconStyle: ToggleButtonProps['style'] = {
  root: {
    color: {
...
const purpleIconStyle: ToggleButtonProps['style'] = {
  root: {
    color: {
...
const permutations = createPermutations<ToggleButtonProps>([
  {
    ...
    onChange: [() => {}],
    style: [blueSquareStyle, purpleRoundedStyle],
  },
  {
    variant: ['icon'],
    pressed: [false, true],
    ...
    onChange: [() => {}],
    ariaLabel: ['Toggle'],
    style: [blueIconStyle, purpleIconStyle],
  },
]);
