        ...
        content={
          <Table
            ...
            renderLoaderLoading={({ item }) => (
              <LoaderRowWithCounter counter={getLoaderCounterText(item)}>
                <StatusIndicator type="loading">Loading items</StatusIndicator>
              </LoaderRowWithCounter>
            )}
...
function LoaderRowWithCounter({ children, counter }: { children: React.ReactNode; counter: string }) {
  return (
