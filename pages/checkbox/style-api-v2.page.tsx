    ...
    <Checkbox
      ...
      {...{
        styleClassNames: {
          ...
          label: clsx(styles['checkbox-label'], disabled && styles['checkbox-label-disabled']),
          description: clsx(styles['checkbox-description'], disabled && styles['checkbox-description-disabled']),
        },
      }}
    >
      {label}
