...
export default function CheckboxStyleV2() {
  ...
  const shared = { disabled, readOnly, className: styles['styled-checkbox'] };

  const multiselectOptions: MultiselectProps.Options = [
    { value: '1', label: 'First option', className: styles['styled-checkbox-one'], disabled },
    { value: '2', label: 'Second option', className: styles['styled-checkbox-two'], disabled },
    { value: '3', label: 'Third option', className: styles['styled-checkbox-three'], disabled },
  ];
