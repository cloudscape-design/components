    ...
    <Box padding="l">
      ...
      <SpaceBetween size="l">
        ...
        <Container
          header={
            isLoading ? (
              <Box variant="h2" tagOverride="div">
                <Skeleton width="200px" />
                <Skeleton width="250px" variant="text-body-m" />
              </Box>
            ) : (
        ...
        <Container header={<Header variant="h2">Text Content with Skeleton</Header>}>
          <>
            {isLoading ? (
              <Box variant="h3" tagOverride="div">
                <Skeleton width="200px" />
              </Box>
            ) : (
            ...
            <Box variant="p">
              {isLoading ? (
                <>
                  <Skeleton tagOverride="span" />
                  <Skeleton tagOverride="span" width="88%" />
                </>
              ) : (
                <>
