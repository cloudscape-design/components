...
// both count the header row, so `ariaRowcount` is `TOTAL + 1` and data rows start at `ariaRowindex` 2.
const ROW_HEIGHT = 40;
    ...
    <Box padding="l">
      <SpaceBetween size="l">
        ...
        <SpaceBetween size="s">
          ...
          >
            <TableRoot columnLayout={{ type: 'grid', columns: COLUMNS }} ariaRowcount={TOTAL + 1} ariaLabel="Log lines">
              <TableHead>
                <TableHeaderRow>
