...
// by the consumer — the atomic parts contribute `variant='selected'` (visual row surface only; the
// checkbox conveys selection to assistive technologies) and `ariaSort` (the header semantic). The
// control column uses `disablePaddings` cells and a centered checkbox to match the classic Table
// selection column; the name column flexes.
