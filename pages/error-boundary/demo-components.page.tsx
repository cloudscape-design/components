                    ...
                    >
                      <div
                        style={{
                          ...
                          padding: spaceContainerHorizontal,
                      ...
                      <WithErrorBoundary
                        ...
                        fallback={() => ({
                          action: (
                            <Button
                              iconName="refresh"
                              loading={sectionRecovering !== null}
                              onClick={() => {
...
function WithErrorBoundary({
  ...
  feedback?: ErrorBoundaryProps['feedback'];
  ...
  return state !== 'inactive' ? (
    <ErrorBoundary
      ...
      i18nStrings={i18nStrings ?? { headerText: `(${name}) Ooops, something went wrong!` }}
    >
      {children}
    </ErrorBoundary>
  ) : (
