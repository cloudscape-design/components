...
import { filler, secondaryHorizontalContent, secondaryVerticalContent } from './common';
...
export default function SecondaryPage() {
  ...
  const scrollableContent = (
    <div style={{ flex: 1, overflow: 'auto', padding: '16px' }} tabIndex={0}>
      <Box variant="h1">NavigationBar — Secondary</Box>
  ...
  return (
    ...
    >
      {(p === 'top' || p === 'start') && (
        <NavigationBar variant="secondary" placement={p} ariaLabel="Secondary navigation" content={content} />
      )}
      {scrollableContent}
      {(p === 'bottom' || p === 'end') && (
        <NavigationBar variant="secondary" placement={p} ariaLabel="Secondary navigation" content={content} />
