...
// CloudWatch Logs Insights "Show patterns" view on the F1-A2 COMPOUND API.
// Same CloudWatch surface as the F1-A1 config-driven patterns demo, expressed through
// the compound tree (Root / Header / HeaderCell / Body row-template / Cell /
...
//          y-scale is stable across scroll. The F1 framing keeps this consumer-side:
...
export default function CloudWatchPatternsCompoundPage() {
  ...
  // closed over by the frequency cell (F1 keeps this consumer-side; RowApi never exposes
  // the windowed slice).
  ...
  return (
    <>
      <h1>VirtualTable — CloudWatch Logs Insights (Show patterns view, compound)</h1>
      <p>
