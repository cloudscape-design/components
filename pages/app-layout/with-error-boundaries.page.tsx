...
export default function WithErrorBoundariesPage() {
  ...
  useEffect(() => {
    window.addEventListener(
      'error',
      e => {
        console.log('error is caught in the global event handler : ', e);
      },
      true
    );
  }, []);
  ...
  const appLayoutWrapperProps = hasParentErrorBoundary
    ? { onError: (error: any) => console.log('Error caught on the parent error boundary wrapping app layout: ', error) }
    : {};
