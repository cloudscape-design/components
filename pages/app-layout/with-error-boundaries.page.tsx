...
import { AppLayout, Button, Container, ContentLayout, Header, HelpPanel, SpaceBetween, SplitPanel } from '~components';
...
export default function WithErrorBoundariesPage() {
  ...
  return (
    <I18nProvider messages={[messages]} locale="en">
      <ErrorBoundary onError={error => console.log('parent level: ', error)}>
        <AppLayout
