          ...
          <SpaceBetween size="m">
            ...
            <Container header={<Header variant="h2">Widget-only startup reservation</Header>}>
              <SpaceBetween size="s">
                ...
                <p>
                  While ownership is reserved, the widget state keeps breadcrumbs out of the AppLayout toolbar. Mount
                  the header to register the consumer and render the trail there. Unmounting it leaves the toolbar empty
                  because the global reservation remains active.
                </p>
                <p>
