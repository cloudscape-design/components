...
function ConsoleBreadcrumbs({ items }: { items: BreadcrumbGroupProps['items'] }) {
  return <BreadcrumbGroup items={items} ariaLabel="Breadcrumbs" data-source="wrapped-console-component" />;
}
...
export default function GlobalNavBreadcrumbsPage() {
  ...
  return (
    <>
      ...
      <AppLayout
        ariaLabels={labels}
        // Producer: a console page passes a wrapper component to App Layout's slot.
        breadcrumbs={<ConsoleBreadcrumbs items={items} />}
        content={
          <SpaceBetween size="m">
            ...
            <Container header={<Header variant="h2">How to view</Header>}>
              <SpaceBetween size="s">
                ...
                <p>
                  ...
                  Layout <strong>auto-yields</strong>. Its toolbar copy remains in the DOM with{' '}
                  <code>display: none</code> for funnel analytics, while the header renders the visible trail. Unmount
                  the header and App Layout resumes visible rendering.
                </p>
                <p>
                ...
                <p>
                  The slot receives <code>&lt;ConsoleBreadcrumbs&gt;</code>, a wrapper around BreadcrumbGroup. The
                  widgetized BreadcrumbGroup implementation reports its props directly, so wrapper components do not
                  require React-node inspection.
                </p>
