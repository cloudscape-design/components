...
// outcome: it hides the dialog and Dialog returns focus to the "Not helpful"
// button that opened it. Submitting records the feedback, appends a confirmation,
// then closes.
export default function DialogInlineFeedbackPage() {
  ...
  const dismissFeedbackDialog = () => setShowFeedbackDialog(false);

  return (
    <SimplePage title="Dialog use case: Inline feedback">
      <DialogDemo minBlockSize={600}>
        <div
          style={{
            flex: 1,
            display: 'flex',
                ...
                items={[
                  {
                    ...
                    items: [
                      ...
                      },
                      {
                        type: 'icon-button',
                        id: 'not-helpful',
                        iconName: isSubmitted ? 'thumbs-down-filled' : 'thumbs-down',
                        text: 'Not helpful',
                        disabled: isSubmitted,
                        disabledReason: isSubmitted ? '"Not helpful" feedback has been submitted.' : undefined,
                      },
                    ],
                  },
                  {
