...
const sortingIndicatorGroup: IconProviderProps.IconGroups = {
...
export default function Page() {
  ...
  const providerProps: Pick<IconProviderProps, 'icons' | 'iconGroups'> = {
    icons: overrideCarets ? caretIcons : {},
    iconGroups: {
      ...(overrideExpandToggles ? expandToggleGroup : {}),
      ...(overrideSortingIndicators ? sortingIndicatorGroup : {}),
    },
  };
