        ...
        items={[
          {
            ...
            value: (
              <Button
                iconName="remove"
                {...shared}
                {...{ styleClassNames: { root: clsx(styles['button-danger'], disabledStyle) } }}
              >
                Delete resource
              </Button>
            ),
          },
          {
            ...
            value: (
              <Button
                ...
                ariaLabel="Copy"
                {...shared}
                {...{ styleClassNames: { root: clsx(styles['button-circle'], disabledStyle) } }}
              />
            ),
          },
          {
            ...
            value: (
              <Button
                iconName="settings"
                {...shared}
                {...{ styleClassNames: { root: clsx(styles['button-ghost'], disabledStyle) } }}
              >
                Settings
              </Button>
            ),
          },
          {
            ...
            value: (
              <Button
                ...
                href="#"
                external={true}
                {...{ styleClassNames: { root: styles['button-ghost'] } }}
              >
                Preferences
              </Button>
            ),
