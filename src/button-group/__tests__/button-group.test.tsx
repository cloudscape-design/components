...
const items1: ButtonGroupProps.Item[] = [
  {
    ...
    text: 'Feedback',
    items: [
      { type: 'icon-button', id: 'like', text: 'Like', iconName: 'thumbs-up', actionPopoverText: 'Liked' },
      { type: 'icon-button', id: 'dislike', text: 'dislike', iconName: 'thumbs-down', actionPopoverText: 'Disliked' },
    ],
  },
  { type: 'icon-button', id: 'copy', iconName: 'copy', text: 'Copy', actionPopoverText: 'Copied' },
