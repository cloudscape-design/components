...
export interface ErrorBoundaryProps {
  /**
   * Optional error boundary identifier that is passed as detail to the `onError` callback and used in test-utils.
   */
   ...
   */
  onError: (error: Error, info: ErrorInfo, detail: ErrorBoundaryProps.OnErrorAdditionalDetail) => void;
...
export namespace ErrorBoundaryProps {
  ...
  export interface OnErrorAdditionalDetail {
    errorBoundaryId?: string;
  }
}
