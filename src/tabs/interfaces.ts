...
export interface TabsProps extends BaseComponentProps {
   ...
   * - `dismissed` (boolean) - (Optional) Determines whether the tab includes a dismiss icon button. By default, the dismiss button is not included.
   * - `dismissLabel` (boolean) - (Optional) Specifies an aria-label for the dismiss icon button.
   *    When a user clicks on this button the onDismiss handler is called.
   * - `action` (ReactNode) - Action for the tab, rendered next to its corresponding label.
   ...
   * - `onDismiss` (ButtonProps['onClick']) - Called when a user clicks on the dismiss button.
