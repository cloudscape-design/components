...
export default function WizardForm({
  ...
  const { title, info, description, content, errorText, isOptional, __analyticsMetadata } =
    steps[activeStepIndex] || {};
  const ref = useComponentMetadata('WizardForm', PACKAGE_VERSION, { props: {}, analytics: { ...__analyticsMetadata } });
  ...
  return (
    <AnalyticsFunnelStep
      instanceId={__analyticsMetadata?.instanceId}
      ...
      {({ funnelStepProps }) => (
        <div ref={ref}>
          ...
          <InternalForm
            ...
            __analyticsMetadata={__analyticsMetadata}
            {...funnelStepProps}
          >
            {content}
          </InternalForm>
