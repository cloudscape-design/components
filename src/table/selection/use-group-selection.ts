...
export function useGroupSelection<T>({
  ...
  return {
    ...
    getSelectAllProps: (loaderRow): SelectionProps => ({
    ...
    getItemSelectionProps: (item: T, loaderRow): SelectionProps => ({
      name: selectionControlName,
      selectionType: 'multi',
      disabled: false,
      ...
      ariaLabel: loaderRow
        ? joinStrings(
            ariaLabels?.selectionGroupLabel,
            ariaLabels?.itemLoaderSelectionLabel?.({ selectedItems, selectionInverted }, item) ??
