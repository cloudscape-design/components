...
export interface TableProps<T = any> extends BaseComponentProps {
   ...
   * The selection state includes:
   *  * `selectedItems` (Item[]) - corresponds to table's `selectedItems`.
   *  * `itemsCount` (optional, number) - corresponds to table's `totalItemsCount`.
   *  * `selectedItemsCount` (optional, number) - corresponds to table's `totalSelectedItemsCount` or `selectedItems.length`.
  ...
  firstIndex?: number;
  /**
   * Use this property to inform screen readers how many items are selected, if the number is different
   * from `selectedItems.length`.
   */
