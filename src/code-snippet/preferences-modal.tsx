...
interface PreferencesModalProps {
  ...
  themes: CodeSnippetProps['themes'];
  defaultTheme: CodeSnippetProps.Theme;

  onConfirm: (preferences: CodeSnippetProps.Preferences) => void;
  onDismiss: () => void;
}
...
export default (props: PreferencesModalProps) => {
  ...
  const [theme, setTheme] = useState<CodeSnippetProps.Theme>(props.preferences?.theme ?? props.defaultTheme);
  const themeOptions = [
    {
  ...
  const onThemeSelected = (e: NonCancelableCustomEvent<SelectProps.ChangeDetail>) => {
    setTheme(e.detail.selectedOption.value as CodeSnippetProps.Theme);
