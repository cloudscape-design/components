...
export interface ToggleButtonProps extends BaseComponentProps, BaseButtonProps {
  ...
  /**
   * Specifies the URL of a custom icon in pressed state. Use this property if the icon you want isn't available.
   *
   * If you set both `pressedIconUrl` and `pressedIconSvg`, `pressedIconUrl` will take precedence.
   */
