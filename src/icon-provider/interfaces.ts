...
/** Union of all valid icon names: built-in icons and any names added to {@link IconRegistry}. */
export type IconName = BuiltInIconName | (keyof IconRegistry & string);
...
export namespace IconProviderProps {
  export type Icons = {
    [name in IconName]?: ReactNode | null;
  };
}
