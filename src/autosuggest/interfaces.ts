...
import { DropdownOptionItem, OptionDefinition, OptionGroup } from '../internal/components/option/interfaces';
...
export interface AutosuggestProps
   ...
   * @awsuiSystem core
   */
  renderOption?: (option: AutosuggestProps.AutosuggestOptionItem) => ReactNode;
...
export namespace AutosuggestProps {
  ...
  export interface AutosuggestOptionItem extends DropdownOptionItem<Option | OptionGroup> {
