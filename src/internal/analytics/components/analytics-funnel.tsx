...
const InnerAnalyticsFunnelStep = ({ children, stepNumber, instanceId, ...rest }: AnalyticsFunnelStepProps) => {
...
export const AnalyticsFunnelSubStep = ({ children, instanceId }: AnalyticsFunnelSubStepProps) => {
