...
export interface AttributeEditorProps<T> extends BaseComponentProps {
   ...
   * equally spaced and wrapped into multiple rows on smaller viewports. This property is required if more
   * than 8 attributes are specified in the `definition`.
   *
   * A `gridLayout` is an array of objects, containing:
