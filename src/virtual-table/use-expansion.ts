...
// Controlled/uncontrolled expansion state for the R-EXPAND disclosure column.
// Exposes a stable signature so the windowing layout only recomputes when the set of
// expanded ids actually changes, not on every parent render.
