...
// Controlled/uncontrolled expansion state for the R-EXPAND disclosure column. The
// component owns this state and exposes a stable signature so the windowing layout only
// recomputes when the set of expanded ids actually changes, not on every render.
