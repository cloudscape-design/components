...
// VirtualTable (F2-A1) owns the R-EXPAND expansion state. These tests pin the
// controlled/uncontrolled contract and the stable signature the windowing layout depends
// on (the layout only recomputes when the set of expanded ids actually changes).
...
describe('VirtualTable (F2-A1) useExpansion', () => {
