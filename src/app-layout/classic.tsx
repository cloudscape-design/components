...
const ClassicAppLayout = React.forwardRef((props: AppLayoutPropsWithDefaults, ref: React.Ref<AppLayoutProps.Ref>) => {
  const {
    rootRef,
    props: {
      navigation,
      ...
      <div className={clsx(styles.layout, disableBodyScroll && styles['layout-no-scroll'])}>
        {!navigationHide && (
          <Drawer
            ...
            ariaLabels={togglesConfig.navigation.getLabels(ariaLabelsWithDrawers)}
            bottomOffset={placement.insetBlockEnd}
            topOffset={placement.insetBlockStart}
            isMobile={isMobile}
        ...
        {hasDrawers ? (
          ...
          !toolsHide && (
            <Drawer
              ...
              ariaLabels={togglesConfig.tools.getLabels(ariaLabelsWithDrawers)}
              width={toolsWidth}
              bottomOffset={placement.insetBlockEnd}
              topOffset={placement.insetBlockStart}
              isMobile={isMobile}
