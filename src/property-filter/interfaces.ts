...
export interface PropertyFilterProps extends BaseComponentProps, ExpandToViewport, FormFieldControlProps {
  ...
  /**
   * An object configuring the operators for free text filtering. It has the following properties:
   *
   ...
   * * defaultOperator [ComparisonOperator]: Optional parameter that changes the default operator used for free text filtering. Use it only if your API does not support "contains" free test filtering terms.
   */
