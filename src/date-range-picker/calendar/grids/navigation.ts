...
export function moveNextDay(startDate: Date, isDateFocusable: DateRangePickerProps.IsDateEnabledFunction) {
  return moveDay(startDate, isDateFocusable, 1);
}

export function movePrevDay(startDate: Date, isDateFocusable: DateRangePickerProps.IsDateEnabledFunction) {
  return moveDay(startDate, isDateFocusable, -1);
}

export function moveNextWeek(startDate: Date, isDateFocusable: DateRangePickerProps.IsDateEnabledFunction) {
  return moveDay(startDate, isDateFocusable, 7);
}

export function movePrevWeek(startDate: Date, isDateFocusable: DateRangePickerProps.IsDateEnabledFunction) {
  return moveDay(startDate, isDateFocusable, -7);
}

export function moveNextMonth(startDate: Date, isDateFocusable: DateRangePickerProps.IsDateEnabledFunction) {
  return moveMonth(startDate, isDateFocusable, 1);
}

export function movePrevMonth(startDate: Date, isDateFocusable: DateRangePickerProps.IsDateEnabledFunction) {
  return moveMonth(startDate, isDateFocusable, -1);
}

export function moveMonthDown(startDate: Date, isDateFocusable: DateRangePickerProps.IsDateEnabledFunction) {
  return moveMonth(startDate, isDateFocusable, 3);
}

export function moveMonthUp(startDate: Date, isDateFocusable: DateRangePickerProps.IsDateEnabledFunction) {
  return moveMonth(startDate, isDateFocusable, -3);
}
...
export function getBaseDay(date: Date, isDateFocusable: DateRangePickerProps.IsDateEnabledFunction) {
...
export function getBaseMonth(date: Date, isDateFocusable: DateRangePickerProps.IsDateEnabledFunction) {
...
function getBaseDate({
  ...
  isDateFocusable: DateRangePickerProps.IsDateEnabledFunction;
}) {
...
function moveDay(startDate: Date, isDateFocusable: DateRangePickerProps.IsDateEnabledFunction, step: number): Date {
...
function moveMonth(startDate: Date, isDateFocusable: DateRangePickerProps.IsDateEnabledFunction, step: number): Date {
