            ...
            describe('disabled date', () => {
              ...
              describe('disabled with reason', () => {
                ...
                test('has aria-describedby with disabledReason', () => {
                  ...
                  expect(wrapper.findDropdown()!.findMonthAt('left', 3, 3).getElement()).toHaveAttribute(
                    'aria-describedby'
                  );
                });
                ...
                test('should set aria-disabled="true" and unset aria-selected to disabled date', () => {
                  ...
                  changeMode(wrapper, 'absolute');
                  expect(
                    wrapper.findDropdown()!.findMonthAt('left', 3, 3).getElement().getAttribute('aria-disabled')
                  ).toBe('true');
                  expect(
                    wrapper.findDropdown()!.findMonthAt('left', 3, 3).getElement().getAttribute('aria-selected')
                  ).toBe(null);
                });
              });
            });
