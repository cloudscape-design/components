          ...
          dateInputFormat => {
            ...
            describe('accessibility attributes', () => {
              ...
              test('toolbar accessible name', () => {
                ...
                expect(
                  modeSelector.findByClassName(segmentedStyles['segment-part'])!.getElement()
                ).toHaveAccessibleName(i18nStrings.modeSelectionLabel);
              });
            ...
            describe('validation', () => {
              ...
              test('does not display the error message until after the first submit', () => {
                ...
                wrapper.findDropdown()!.findApplyButton().click();
                expect(wrapper.findDropdown()!.findValidationError()?.getElement()).toHaveTextContent(
                  '10 is not allowed.'
                );
