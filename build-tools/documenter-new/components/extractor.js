...
exports.extractExports = exports.extractFunctions = exports.extractProps = exports.extractDefaultValues = void 0;
// Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
// SPDX-License-Identifier: Apache-2.0
...
function extractFunctions(propsSymbol, checker) {
  ...
  const refType = (0, type_utils_1.unwrapNamespaceDeclaration)(namespaceDeclaration)
    ...
    .find(type => {
      var _a, _b;
      return (
        ((_b = (_a = type.getSymbol()) !== null && _a !== void 0 ? _a : type.aliasSymbol) === null || _b === void 0
          ? void 0
          : _b.getName()) === 'Ref'
      );
    });
  ...
  return refType
    ...
    .map(value => {
      ...
      if (realType.getCallSignatures().length === 0) {
        throw new Error(
          `${propsName}.Ref should contain only methods, "${value.name}" has a "${(0, type_utils_1.stringifyType)(type, checker)}" type`
        );
      }
      return {
        name: value.name,
