...
module.exports = parallel([
  ...
  generatePackageJson(path.join(workspace.targetPath, 'components-definitions'), {
    ...
    exports: {
      ...
      // Beta components' api-docs, generated by the beta documenter pass into a separate folder so
      // they don't clobber the stable `components` barrel. Consumed by the website's beta section.
      './components-beta': './components-beta/index.js',
